...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['ciudad'])) {
    $ciudades = $ctrl->buscarCiudad(trim($_POST['ciudad']));
    if (empty($ciudades)) $error = "No se encontró la ciudad: " . htmlspecialchars($_POST['ciudad']);
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8"><title>Aplicacion del tiempo</title>
    <style>
